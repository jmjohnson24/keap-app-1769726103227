  ...
  const renderContactView = () => (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => selectedContact && handleEdit(selectedContact)}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow border">
          ...
          <div className="space-y-2">
            ...
            <p><strong>Address:</strong> {selectedContact?.addresses?.[0]?.line1 || 'N/A'}</p>
            <p><strong>City:</strong> {selectedContact?.addresses?.[0]?.locality || 'N/A'}</p>
            <p><strong>State:</strong> {selectedContact?.addresses?.[0]?.region || 'N/A'}</p>
            <p><strong>ZIP:</strong> {selectedContact?.addresses?.[0]?.zip_code || 'N/A'}</p>
          </div>
        </div>
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto">
            {notes.map((note) => (
              <div key={note.id} className="bg-gray-50 p-3 rounded border">
                ...
                <p className="text-gray-600 text-sm mt-1">{note.body}</p>
